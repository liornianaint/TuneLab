...
class ProjectStructureTests(unittest.TestCase):
    def test_tunelab_namespace_and_entrypoint_names_are_current(self) -> None:
        ...
        self.assertTrue((ROOT / "tunelab" / "colorchecker" / "engine.py").is_file())
        self.assertTrue((ROOT / "tunelab" / "colorchecker" / "ui.py").is_file())
    ...
    def test_packaging_exposes_tunelab_commands(self) -> None:
        ...
        self.assertIn('"pillow-heif>=0.18"', metadata)
