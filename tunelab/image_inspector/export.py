...
def _base_row(
    ...
    *,
    ...
    return {
        ...
        "display_luminance_0_255": stats.display_luminance,
    ...
    row.update(
        {
            ...
            "delta_display_luminance_0_255": comparison.delta_display_luminance,
