...
def show_about_dialog(root: tk.Misc, icon_path: Path | None = None) -> tk.Toplevel:
    ...
    title_font = "MatrixCorrectTitleFont" if "MatrixCorrectTitleFont" in available_fonts else "TkHeadingFont"
    body_font = "MatrixCorrectBodyFont" if "MatrixCorrectBodyFont" in available_fonts else "TkDefaultFont"
    small_font = "MatrixCorrectSmallFont" if "MatrixCorrectSmallFont" in available_fonts else "TkDefaultFont"
